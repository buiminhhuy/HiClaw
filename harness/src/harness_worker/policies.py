"""Pure Matrix policy helpers for the harness worker.

Vendored from ``hermes/src/hermes_matrix/policies.py``. These helpers
intentionally avoid importing any Matrix SDK. They only model the policy layer
AgentTeams applies around a runtime's Matrix traffic: outbound mention
enrichment, dual allow-lists, and copaw-style history buffering.
"""
